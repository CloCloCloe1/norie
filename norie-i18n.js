...
const pairs = {
  ...
  "product.title": ["Product Details | Norie", "商品详情｜Norie"],
  "product.back": ["Back to Shop", "返回选购"],
  "product.color": ["Color", "颜色"],
  "product.style": ["Style", "花色"],
  "product.viewStyle": ["View this style", "查看这个花色"],
  "product.styleSelected": ["Style selected.", "已选择此花色。"],
  "product.style.pinkBow": ["Pink Bow", "粉色蝴蝶结"],
  "product.style.cherryPink": ["Cherry Pink", "樱桃粉"],
  "product.style.florieWhite": ["Florie White", "花漾白"],
  "product.style.cherryWhite": ["Cherry White", "樱桃白"],
  "product.contents": ["Details", "商品详情"],
  "product.add": ["Add to cart", "加入购物车"],
  "product.added": ["Added to cart.", "已加入购物车。"],
  "product.unavailable": ["This product is unavailable.", "找不到这个商品。"],
  "product.plumeria.description": ["A polished Plumeria trio for matching everyday hairstyles.", "一套精致鸡蛋花抓夹，为日常造型增添柔美点缀。"],
  "product.plumeria.contents": ["One large claw clip and two small claw clips in your selected color.", "包含一只大号抓夹和两只小号抓夹，颜色任选。"],
  "product.pinkBow.description": ["A glossy pink claw clip finished with delicate white bows and crystals.", "亮泽粉色抓夹，点缀精致白色蝴蝶结与水钻。"],
  "product.pinkBow.contents": ["One fixed-design claw clip in Pink.", "一只粉色固定设计抓夹。"],
  "product.cherryPink.description": ["A glossy pink claw clip with playful cherry crystal details.", "亮泽粉色抓夹，搭配俏皮樱桃水钻细节。"],
  "product.cherryPink.contents": ["One fixed-design claw clip in Pink.", "一只粉色固定设计抓夹。"],
  "product.florieWhite.description": ["A pearl white claw clip with soft floral and butterfly details.", "珍珠白抓夹，点缀柔美花朵与蝴蝶细节。"],
  "product.florieWhite.contents": ["One fixed-design claw clip in White.", "一只白色固定设计抓夹。"],
  "product.cherryWhite.description": ["A pearl white claw clip with bright cherry crystal details.", "珍珠白抓夹，搭配亮眼樱桃水钻细节。"],
  "product.cherryWhite.contents": ["One fixed-design claw clip in White.", "一只白色固定设计抓夹。"],
  ...
  "home.social.title": ["Follow us and see more from Norie", "关注我们，发现更多 Norie 灵感"],
  "home.social.follow": ["Follow us", "关注我们"],
  "home.social.viewInstagram": ["View on Instagram", "前往 Instagram 查看"],
  "home.social.viewTikTok": ["View on TikTok", "前往 TikTok 查看"],
  "home.social.viewRedNote": ["View on RedNote", "前往小红书查看"],
  "home.social.viewDouyin": ["View on Douyin", "前往抖音查看"],
  "home.newsletter.title": ["KEEP IN TOUCH", "保持联系"],
  "home.newsletter.copy": ["Join us for new samples, custom-order updates, and launch news.", "订阅新品、定制更新与上新消息。"],
  "home.newsletter.email": ["Email address", "邮箱地址"],
  "home.newsletter.subscribe": ["Subscribe", "订阅"],
  "home.newsletter.placeholder": ["Enter your email", "请输入邮箱"],
