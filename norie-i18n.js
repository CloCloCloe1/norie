...
const pairs = {
  ...
  "home.hero.title": ["Custom Hair Pieces", "把名字戴在头发上"],
  ...
  "home.coming.title": ["Coming Soon", "新品正在靠近"],
  ...
  "shop.large": ["Large comb", "Bamboo Paddle Brush"],
  "shop.small": ["Small comb", "Flat Brush"],
  "shop.clip": ["Claw clip", "抓夹"],
  "shop.essentials": ["Essentials Hairstyling Set", "日常造型限定套装"],
  "shop.baby": ["Baby Hairstyling Set", "迷你造型限定套装"],
  "shop.largePink": ["Pink Large Comb", "粉色 Bamboo Paddle Brush"],
  "shop.largeWhite": ["White Large Comb", "白色 Bamboo Paddle Brush"],
  "shop.smallPink": ["Pink Small Comb", "粉色 Flat Brush"],
  "shop.smallWhite": ["White Small Comb", "白色 Flat Brush"],
  ...
  "custom.hero": ["Customize your set", "定制你的专属款"],
  ...
  "custom.pink": ["Pink", "柔雾粉"],
  "custom.white": ["White", "珍珠白"],
  "custom.pinkStones": ["Pink stones", "粉色水钻"],
  "custom.whiteStones": ["White stones", "白色水钻"],
